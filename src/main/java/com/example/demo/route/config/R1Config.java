...
//        var s3 = new StepEh("direct:r1:s3", "direct:r1:s4", "processor3", new ErrorHandler(null, 7, null, null));
        ...
        var s4 = new LastStep("direct:r1:s4", "processor4");

        var ss1 = new FirstStep("direct:r1:ss1", "direct:r1:ss2", "processor5");
        var ss2 = new Step("direct:r1:ss2", "direct:r1:ss3", "processor6");
        var ss3 = new LastStepBm("direct:r1:ss3", "processor7");
